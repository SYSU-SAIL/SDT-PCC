...
# import dataset_utils_cpp
from src.ops import lidar_ops as dataset_utils_cpp
import math
import numpy as np
import yaml
...
class PCTransformer:
    ...
    def point_cloud_to_range_image(self, point_cloud):
        if self.even_dist:
            range_image = dataset_utils_cpp.point_cloud_to_range_image_even(point_cloud.astype(np.float32), self.H,
                                                                            self.W,
